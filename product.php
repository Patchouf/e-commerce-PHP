...
function getSomethink($table, $value)
{
    global $conn;
...
$MainRow = getSomethink('items', $value);
$name = $MainRow["Name"];
$price = $MainRow["Price"];
$description = $MainRow["Description"];
$category = $MainRow["Category"];
$photo = getSomethink('photo', $MainRow["Photo"])["Link"];
$seller = getSomethink('user', $MainRow["Seller"])["Name"];
    ...
    <div class="row g-5 mt-5">
        <div class="col-md-8">
            <article class="blog-post">
                ...
                <p class="blog-post-meta">par <a href="#"><?php echo $seller ?></a></p>
                <hr>
